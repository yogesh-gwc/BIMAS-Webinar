    ...
    <section className="relative overflow-hidden min-h-[90vh] flex items-center">
      ...
      <div className="container-narrow relative z-10 section-padding">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-display leading-tight mb-4 text-foreground">
            BIMAS – BI Migration{" "}
            <span className="gradient-text">Accelerator as a Service</span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground font-medium mb-4 leading-relaxed">
          ...
          <p className="text-base text-muted-foreground mb-8 max-w-2xl leading-relaxed">
            A structured, AI-assisted framework for migrating analytics across BI
            platforms. BIMAS enables organizations to modernize analytics safely by
            reducing migration effort, cost, and operational risk—without locking
